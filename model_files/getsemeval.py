...
def get_semeval(years, aspects, rest_lap='r', use_attribute=False, dedup=False):
    # faqat SemEval 2014 train/test o‘qiladi
    if rest_lap == 'r':
        ...
        if 14 in years and len(years) == 1:
            ...
            # exp on rest [14], conflict + neutral -> neutral
    ...
    print("# Train: {}\t# Test: {}\t# Dup: {}".format(len(semeval_train), len(semeval_test), dup))
